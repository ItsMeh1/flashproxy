// This code gets injected into every proxied page by the HTML rewriter
// It lives in the global scope of the target page, not your browser chrome

(function(){
    const __pp = window.__flashproxy_prefix || '/proxy';
    const __origin = window.__flashproxy_origin || location.origin;
    ...
    // location spoofing
    const _loc = new URL(window.__flashproxy_page || __origin);
    ...
    console.log('[FlashProxy] Runtime shim loaded');
})();
